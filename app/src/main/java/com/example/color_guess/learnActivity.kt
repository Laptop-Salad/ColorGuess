...
class learnActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var clickCount = 0
        val returnButton = findViewById<Button>(R.id.learnReturn)
        val nextButton = findViewById<Button>(R.id.learnNext)
        ...
        //Listens to return button and starts the main activity when clicked (start page)
